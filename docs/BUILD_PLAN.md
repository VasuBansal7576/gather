...
The owner workspace and guided app setup are integrated locally; the combined setup-to-booking browser review and recurring runtime startup failure remain open.
